...
class VehicleManagerNode(Node):
    def __init__(self):
        ...
        self.sensor_config = (
            self.get_parameter("sensor_config").get_parameter_value().string_value
        )

        self.get_logger().info(
            f"Vehicle Manager started with parameters: {self.host}, {self.port}"
        )
        ...
        self.get_logger().info(
            "Vehicle Manager Node started, waiting for lap completion."
        )
    ...
    def lap_callback(self, msg):
        ...
        """
        self.get_logger().info(
            f"Lap completed! Triggering vehicle spawn and data collection: {msg.data}"
        )
