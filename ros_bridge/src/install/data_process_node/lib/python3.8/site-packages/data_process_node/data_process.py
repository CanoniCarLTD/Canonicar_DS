...
class DataProcessNode(Node):
    def __init__(self):
        ...
        self.vehicle_data_subscriber = self.create_subscription(
            Float32MultiArray, "/carla/vehicle/data", self.vehicle_data_callback, 10
        )
    ...
    def location_callback(self, msg):
        ...
        self.get_logger().info(
            f"Distance from start: {distance:.2f} m, start point: {self.start_point} , current position: {self.vehicle_location}"
        )
        if distance < 1:
    ...
    def save_data_to_excel(self):
        ...
        try:
            ...
            if (
                "vehicle_physics" in lap_entry
                and len(lap_entry["vehicle_physics"]) >= 14
            ):
